...
namespace game_framework {
	...
	*/
	int CMovingBitmap::GetHeight()
	{
		...
		return (int)((locations[frameIndex].bottom - locations[frameIndex].top) * scaleFactor);
	}
	...
	*/
	int CMovingBitmap::GetWidth()
	{
		...
		return (int)((locations[frameIndex].right - locations[frameIndex].left) * scaleFactor);
	}
